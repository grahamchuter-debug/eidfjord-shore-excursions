...
const outPath = path.join(root, "src/data/eidfjord-cruise-schedules.generated.json");
const payload = JSON.parse(readFileSync(sourcePath, "utf8"));
const rows = (payload.rows || []).filter((r) => r.port === "eidfjord");
const years = {};
...
const out = {
  port: "eidfjord", portDisplayName: "Eidfjord",
