...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Eidfjord Shore Excursions: independent cruise planning information for Eidfjord port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Eidfjord Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Eidfjord cruise day"
      ctaText="Explore waterfall, sightseeing and Nature Centre options, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Eidfjord. It is not a substitute for official cruise-line
