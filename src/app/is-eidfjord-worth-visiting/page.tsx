...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The village is walkable independently. Vøringsfossen and Hardangervidda require road transport, so organised shore excursions are the practical choice for most cruise passengers.",
  },
] as const;
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          Use the{" "}
          <Link href="/#planner">Eidfjord port-day planner</Link> and our{" "}
