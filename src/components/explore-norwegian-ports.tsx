...
export const explorePortsFromEidfjord: ExploreNorwegianPortsConfig = {
  intro: (
    <>
      If your itinerary includes more than one Norwegian port, plan each call
      around your ship&apos;s timetable before you sail. Many Hardangerfjord
      cruises pair Eidfjord with{" "}
      <a
