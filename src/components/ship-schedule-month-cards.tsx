...
import {
  ...
  type getEidfjordMonthSummaries,
} from "@/lib/eidfjord-schedules";

type MonthSummary = ReturnType<typeof getEidfjordMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {eidfjordScheduleIntegrity.lastDate
