...
import {
  formatScheduleDate,
  type EidfjordScheduleEntry,
} from "@/lib/eidfjord-schedules";

type SortKey = keyof Pick<
  EidfjordScheduleEntry,
...
function compareValues(
  a: EidfjordScheduleEntry,
  b: EidfjordScheduleEntry,
  key: SortKey,
): number {
    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          aria-label="Search Eidfjord ship schedule"
